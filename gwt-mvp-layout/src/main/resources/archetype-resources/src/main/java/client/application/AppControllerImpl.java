...
import ${package}.client.place.PlaceLayoutHandler;
import ${package}.client.util.ActivityManagerInitializer;
...
public class AppControllerImpl implements AppController {
     ...
     * @param activityManagerInitializer unused parameter, it's here just to force GIN's initialization
     *                                   of ActivityManagers
     */
    @Inject
